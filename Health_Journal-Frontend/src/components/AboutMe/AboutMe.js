...
const AboutMe = (props)=>{
    return(
        <View style={styles.container}>
            ...
            <Text style={styles.textParagraph}>Gender: {props.me.gender}</Text>
            <Text style={styles.textParagraph}>Height: {props.me.height} cm</Text>
            <Text style={styles.textParagraph}>Weight: {props.me.weight} kg</Text>
            <Text style={styles.textParagraph}>BMI: {props.me.BMI}</Text>
        </View>
    )
}
